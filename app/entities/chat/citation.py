...
class Citation(UUIDMixin, TimestampMixin, Base):
    ...
    resource_id: Mapped[UUID] = mapped_column(
        ...
        nullable=False,
        index=True,
    ) # which file, issue, page, message or document that text came from. Reachable through the chunk, and stored anyway: rendering a source list is the common read, and it should not have to join through chunks to name a file
