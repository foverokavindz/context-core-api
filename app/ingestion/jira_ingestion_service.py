...
class JiraIngestionService:
    ...
    def ingest(
        ...
        `max_issues` overrides the service default for this run only.

        Raises IngestionError subclasses for whole-run failures - bad
        credentials, an invisible project, a rate limit. Problems with
        individual issues are collected into `errors` and do not stop the run.
        """
